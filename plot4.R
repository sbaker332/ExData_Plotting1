plot4 <- function(){
  ...
  ##get the reactive power data
  rpower <- as.numeric(as.character(febdata[, "Global_reactive_power"]))
  ...
  ##set the plotm area 2 x 2
  par(mfrow=c(2,2))
  
  ##generate plot 1 Global Active Power
  plot(dateseries, power, ylab="Global Active Power", type="l", xlab="")
  
  ##generate plot 2 Voltage
  plot(dateseries, voltage, ylab="Voltage", xlab="datetime", type="l")
  ...
  ##generate plot 4
  plot(dateseries, rpower, ylab="Global_reactive_power", xlab="datetime", type="l")
